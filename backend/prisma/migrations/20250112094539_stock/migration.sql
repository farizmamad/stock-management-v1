/*
  ...
  - You are about to drop the column `created_at` on the `StockEntry` table. All the data in the column will be lost.
  - You are about to drop the column `created_at` on the `StockLedger` table. All the data in the column will be lost.
